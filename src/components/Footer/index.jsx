      ...
      <footer className="footer bg-gray-900 text-white py-6">
        ...
        <div className="footer-content">
          ...
          <p className="indent-4 text-gray-300">
            ...
            deleniti iste sit enim. Please do not copy YiJu, Chao's code! Veniam eos sequi laudantium optio, saepe
        ...
        <div className="footer-followUs">
          ...
          <div className="flex items-center space-x-4">
            <a href="#">
              <img className="w-8 h-8" src="/img/nn-icon-facebook.svg" alt="facebook" />
            </a>
            <a href="#">
              <img className="w-8 h-8" src="/img/nn-icon-instagram.svg" alt="instagram" />
            </a>
            <a href="#">
              <img className="w-8 h-8" src="/img/nn-icon-tiktok.svg" alt="tiktok" />
            </a>
          </div>
        </div>
        ...
        <p className="footer-copyRight text-center text-gray-400 opacity-60">
          © 2006 - 2023 Copyright Digital Technology Design/ made by YiJu, Chao
        </p>
      </footer>
    </div>
  );
